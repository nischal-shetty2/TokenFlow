export const tokenList = {
  ...
  FeGn77dhg1KXRRFeSwwMiykZnZPw5JXW6naf2aQgZDQf: {
    ...
    decimals: 9,
    freezeAuthority: null,
    mintAuthority: "9zyPU1mjgzaVyQsYwKJJ7AhVz5bgx5uc1NPABvAcUXsT",
    tokenType: "Legacy",
    tokenList: {
    ...
    tokenMetadata: {
      onChainInfo: {
        ...
        symbol: "wWETH",
        metadata: "GgeT171QgD8dfwmH3MxFqc9HEzGgt7BiaCMevcjjsfTP",
        updateAuthority: "9zyPU1mjgzaVyQsYwKJJ7AhVz5bgx5uc1NPABvAcUXsT",
        isMasterEdition: null,
        edition: null,
        uri: "",
        sellerFeeBasisPoints: 0,
